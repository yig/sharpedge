...
Converts .curve format to OBJ format for use in 3D modeling software like Blender.
Automatically removes duplicate vertices to create cleaner, more efficient output.
...
if __name__ == "__main__":
    ...
    if len(sys.argv) >= 3:
        ...
        # First analyze for duplicates
        print("Analyzing input file for duplicates...")
        analyze_duplicates(input_file, tolerance)
        print("\n" + "="*50 + "\n")
        
        # Then convert
        convert_curve_to_obj_no_duplicates(input_file, output_file, tolerance)
        
    else:
        print("Usage: python curve_to_obj.py input.curve output.obj [tolerance]")
        print("  tolerance: optional, default 1e-6")
        print("  Example: python curve_to_obj.py Speaker.curve Speaker.obj 1e-6")

# Example usage:
# convert_curve_to_obj_no_duplicates('Speaker.curve', 'Speaker.obj')
# analyze_duplicates('Speaker.curve')
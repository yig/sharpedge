"""
Clean OBJ Sketch File

This script loads a curve sketch (in OBJ format), removes:
  - Duplicate vertices (within a distance tolerance)
  - Duplicate polylines (including reversed ones)
  - Redundant consecutive vertex indices in each polyline

It writes the cleaned sketch back to a new OBJ file.

Usage:
    python clean_sketch_obj.py input.obj output_clean.obj
"""

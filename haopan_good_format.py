...
process2 = subprocess.Popen(['python', 't2f_center_and_scale.py', curve_file, temp2])
...
process7 = subprocess.Popen(['python', 'curve_split_preprocess.py', temp5, '3d-sketches/haopan/' + curve_name + '.obj'])

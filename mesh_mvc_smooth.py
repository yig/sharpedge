...
def smooth_laplacian_magnitude(V, F, adjacency_list, iterations=4, threshold=1e-4, method = 'avg'):
    V_new = V.copy()
...
if __name__ == "__main__":
    ...
    v_smoothed = smooth_laplacian_magnitude(v, f, adj, iterations=5, threshold=1e-5, method='avg')
